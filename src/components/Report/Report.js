...
import { reportFields, reportFormValues, reportValidation, reportEditFields, reportEditValidation } from '../Form/FormConsts.js';
  ...
  if(reportId && report){
      ...
      <section className={classes.section_report}>
        ...
        >
          <div className={classes.select_list}>
            <select className={classes.select} defaultValue={report.type} name="type" onClick={(e) => setType(e.target.value)}>
          ...
          &&
          <div className={classes.select_list}>
            <select defaultValue={report.officer} className={classes.select} name="officer" onClick={(e) => setOfficer(e.target.value)}>
    ...
    return (
      <section className={classes.sectionReport}>
        ...
        >
          <div className={classes.select_list}>
            <select className={classes.select} name="type" onClick={(e) => setType(e.target.value)}>
            <option value="">Выберите тип велосипеда</option>
              <option value="city">Городской</option>
              <option value="road">Шоссейный</option>
              <option value="sport">Спортивный</option>
          ...
          &&
          <div className={classes.select_list}>
            <select name="officer" className={classes.select} onClick={(e) => setOfficer(e.target.value)}>
              <option value="">Выберите сотрудника</option>
              {officers.filter((el) => el.approved === true).map((el) => (
                  <option value={el._id} key={el._id}>{el.lastName} {el.firstName}</option>
              ))}
