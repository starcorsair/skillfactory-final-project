...
import InfoFor from "../InfoFor/InfoFor";
import classes from "./ListFor.module.css";
...
const ListFor = ({ report, officer, type }) => {
  if (type === "officer") {
    return (
      <li className={classes.list_item}>
        ...
        <button className={classes.button_link}>
          {/* <Link to={`/officers/id=${officer._id}`} className={classes.link}>
            Подробнее
          </Link>{" "} */}
        </button>
      </li>
    ...
    return (
      <li className={classes.list_item}>
        ...
        <button className={classes.button_link}>
          {/* <Link to={`/reports/id=${report._id}`} className={classes.link}>
            Подробнее
          </Link>{" "} */}
        </button>
      </li>
